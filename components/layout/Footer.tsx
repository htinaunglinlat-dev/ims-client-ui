    ...
    <footer className="border-t border-border bg-card/40">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-1">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Engineering modern software, AI, and IoT systems for ambitious teams
            worldwide.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm text-muted-foreground">
            <li>hello@lucky7andone.com</li>
            <li>+92 300 0000000</li>
            <li>Lahore · Dubai · Remote</li>
          </ul>
        </div>
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row justify-between gap-2 text-xs text-muted-foreground">
          <p>© {new Date().getFullYear()} Lucky7andOne. All rights reserved.</p>
